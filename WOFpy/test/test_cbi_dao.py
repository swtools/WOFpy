...
class TestCbiDao(unittest.TestCase):
    def setUp(self):
        ...
        self.dao = CbiDao(cbi_cache_connection_string)
        ...
        self.known_sites = {
            ...
            '154': 'ASPA Pier E (mb0301)',
            '155': 'Choctaw Point (mb0201)',
            '156': 'Fort Morgan Met (87346731)',
            '158': 'USCG Sector Mobile (87368971)',
            '159': 'Dauphin Island (87351801)',
            '160': 'Mobile State Docks (87370481)',
            '163': 'Dock E, East Harbor, Port of Pascagoula (87410411)',
            '164': 'Range A Rear, Port of Pascagoula (87410941)',
            '165': 'Dock C, West Harbor, Port of Pascagoula (87415011)',
            '166': 'NOAA Lab, Pascagoula River, MS (87415331)',
            '167': 'Northrop Grumman Current, Pascagoula, MS (ps0301)',
            '169': 'Petit Bois Island, Port of Pascagoula (87410031)',
            '170': 'National Park Service - Baffin Bay',
            '171': 'National Park Service - Bird Island',
            '172': 'Outer Range, Port of Gulfport (87447071)',
            '173': 'West Pier, Port of Gulfport (87456511)',
            '174': 'West Pier Current Meter, Port of Gulfport (gp0401)',
            '181': 'Realitos Peninsula (87792801)',
            '183': 'Mobile Container Terminal (mb0401)',
            '185': 'Nueces Bay (87752441)',
            '190': 'USCG Sabine CU (sn0201)',
            '191': 'Port of Beaumont CU (sn0601)',
            '192': 'Sabine Front Range CU (sn0301)',
            '193': 'West Port Arthur Bridge CU (sn0401)',
            '194': 'Rainbow Bridge CU (sn0501)',
