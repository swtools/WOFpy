...
if __name__ == '__main__':
    ...
    lbr_wof = WOF(lbr_dao)    
    lbr_wof.config_from_file('odm/lbr_config.cfg')
    ...
    sara_wof.config_from_file('odm/sara_config.cfg')
    ...
    combined_app = DispatcherMiddleware(NotFound, {
        ...
        '/cbi': cbi_flask_app,
        '/sara': sara_flask_app,
        '/lbr/soap/wateroneflow': lbr_soap_wsgi_app,        
        '/swis/soap/wateroneflow': swis_soap_wsgi_app,
        '/cbi/soap/wateroneflow': cbi_soap_wsgi_app,
        '/sara/soap/wateroneflow': sara_soap_wsgi_app
    })
